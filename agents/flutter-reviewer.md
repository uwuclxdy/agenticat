...
description: "Read-only Flutter/Dart diff/PR reviewer: correctness, async/context safety, rebuild perf, state-management misuse, clarity, with file:line and severity. Use when a Flutter or Dart diff, PR, or staged change needs review. Spawn one per diff. Not for implementing (`flutter-pro`)."
