---
name: golang-pro
description: "Implements or refactors Go against the repo's conventions, verifying with its go build/test/vet or golangci-lint gate. Use when a Go package, feature, or fix needs building. Spawn one per module-sized task."
---
