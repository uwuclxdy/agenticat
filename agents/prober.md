---
name: prober
description: "Runs a build, test, lint, or any command and returns a pass/fail probe (exit code, warn/error counts) instead of the full log. Never mutates. Spawn one per check."
